    ...
    <div className="flex min-h-screen flex-col bg-background md:flex-row">
      ...
      <aside className="hidden md:flex fixed inset-y-0 left-0 z-40 w-64 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
        <div className="flex items-center gap-3 border-b border-sidebar-border px-6 py-5">
          <Image src="/logo.jpg" alt="IILPD" width={40} height={40} className="rounded-lg" priority />
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-sidebar-primary">IILPD</p>
