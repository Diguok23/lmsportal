      ...
      <header className="border-b border-white/10">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-3">
            <Image src="/logo.jpg" alt="IILPD" width={40} height={40} className="rounded-lg" />
            <span className="text-sm font-bold text-primary-foreground uppercase tracking-widest">IILPD Student Portal</span>
          </Link>
        ...
        <div className="mx-auto max-w-2xl px-6 py-16">
          ...
          <form onSubmit={handleVerify} className="bg-white rounded-lg shadow-lg p-6 mb-8">
            ...
            <div className="flex gap-2">
              <Input
                placeholder="e.g., IILPD-2024-ABC123"
                value={certId}
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-green-700 text-sm">This is a valid IILPD certificate</p>
                </div>
              </div>
